# Read in bim file
bim <- read.table("~/measures/tran_4722.bim",stringsAsFactors=F)[-1,]
...
write.table(bim,"4722.adj.bim",quote = F,row.names = F,col.names=F,sep="\t")
...
write.table(mismatch,"4722.mismatch",quote = F,row.names = F,col.names = F)
