...
n=length(dir)
merge.data1=read.table("/export/home/guiyuanyuan/measures/covar",header=T,dec=".",stringsAsFactors=F)[[
,-1]
merge.data2=read.table("/export/home/guiyuanyuan/measures/SCZ.profile",header=T,dec=".",stringsAsFactoo
rs=F)[,c(2,6)]
merge.data3=read.table("/export/home/guiyuanyuan/measures/BD.profile",header=T,dec=".",stringsAsFactorr
s=F)[,c(2,6)]
merge.data7=read.table("/export/home/guiyuanyuan/measures/MDD.profile",header=T,dec=".",stringsAsFactoo
rs=F)[,c(2,6)]
merge.data8=read.table("/export/home/guiyuanyuan/measures/ASD.profile",header=T,dec=".",stringsAsFactoo
rs=F)[,c(2,6)]
